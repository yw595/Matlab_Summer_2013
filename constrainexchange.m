...
'EX_fol(e)','EX_ncam(e)','EX_bz(e)','EX_pydxn(e)','EX_ribflv(e)','EX_thm(e)','EX_adpcbl(e)','EX_inost(e)','EX_ca1(e)','EX_so4(e)','EX_k(e)','EX_cl(e)','EX_na1(e)',...
'EX_hco3(e)','EX_pi(e)','EX_glc(e)','EX_gthrd(e)','EX_o2(e)','EX_co2(e)','EX_h2o(e)','EX_h(e)'};
model2=model1;
for i=1:length(model2.rxns)
    if (~isempty(regexp(model2.rxns{i},'^EX(.)*\(e\)$')) && sum(strcmp(model2.rxns{i},exctokeep))==0)
        %model2.rxns{i}
        model2.lb(i)=0;
    end
end
